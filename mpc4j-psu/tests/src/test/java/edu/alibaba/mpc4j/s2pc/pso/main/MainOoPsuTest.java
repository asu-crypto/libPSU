...
public class MainOoPsuTest extends AbstractTwoPartyMemoryRpcPto {
    ...
    public static Collection<Object[]> configurations() {
        ...
        configurations.add(new Object[]{PsuType.USENIX_JSZDG22.name(), "LLL24_FLAT_NET", true});
        configurations.add(new Object[]{PsuType.USENIX_JSZDG22_SFS.name(), "LLL24_FLAT_NET", true});
        configurations.add(new Object[]{PsuType.PKC_GMRSS21.name(), "LLL24_FLAT_NET", true});
        configurations.add(new Object[]{PsuType.USENIX_JSZDG22.name(), "GMR21_NET", true});
        configurations.add(new Object[]{PsuType.USENIX_JSZDG22_SFS.name(), "GMR21_NET", true});
        configurations.add(new Object[]{PsuType.PKC_GMRSS21.name(), "GMR21_NET", true});
