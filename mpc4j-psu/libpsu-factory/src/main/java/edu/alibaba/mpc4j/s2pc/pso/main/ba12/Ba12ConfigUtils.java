...
/**
 * Reads BA12 protocol properties shared by the library and command-line driver.
 */
public class Ba12ConfigUtils {
  ...
  public static Ba12Operation readOperation(Properties properties) {
    ...
    String paperPrefix = ProtocolNames.ASIACCS_BLA_AGU12 + "_";
    if (name.startsWith(paperPrefix)) {
      name = "BA12_" + name.substring(paperPrefix.length());
    }
