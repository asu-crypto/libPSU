...
/**
 * C_KisSon05 PSI config (Kissner–Song polynomial PSI with Paillier).
 */
public class Ks05PsiConfig extends AbstractMultiPartyPtoConfig implements PsiConfig {
    /**
    ...
    private Ks05PsiConfig(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Ks05PsiConfig> {
        ...
        @Override
        public Ks05PsiConfig build() {
            return new Ks05PsiConfig(this);
        }
    }
}
