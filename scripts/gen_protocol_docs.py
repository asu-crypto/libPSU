...
PROTOCOLS: list[dict] = [
    ...
    },
    {
        ...
        "security": "Semi-honest",
        "output": "One-sided (client union)",
        "module": "protocols/balanced/czz24",
    ...
    },
    {
        ...
        "security": "Semi-honest",
        "output": "One-sided (client union)",
        "module": "protocols/balanced/cssw25",
    ...
    },
    {
        ...
        "module": "protocols/balanced/hwy26",
    ...
    },
    {
        ...
        "security": "Semi-honest",
        "output": "One-sided (client union)",
        "module": "protocols/balanced/fri07",
    ...
    },
    {
        ...
        "module": "protocols/malicious/jszg24",
    ...
    },
    {
        ...
        "module": "protocols/balanced/ours",
    ...
    },
    {
        "name": "C:KisSon05",
        "functionality": "Balanced PSU",
        "family": "Kissner–Song 2005 Paillier polynomial PSU (same algebra family as ACNS:Frikken07)",
        "security": "Semi-honest",
        "output": "One-sided (client union)",
        ...
        "factory": "PsuFactory",
        "driver": "PsuMain",
        "bench_dir": "psu/23_KS05",
        "ot_status": "NO_OT",
        "init": "Paillier keygen (client).",
        "online": "Encrypted root polynomial; server returns randomized tuples; client recovers Y \\ X and builds union.",
        "notes": (
            "Fair-bench default: skip_warmup=true and ks05_max_set_size=256; harness skips log sizes above "
            "PSU_FAIR_KS05_MAX_LOG_SIZE (default 8). Legacy PsiType/PsiMain drivers remain for unit tests only."
        ),
    },
    {
        "name": "JOC:HazNis12",
        "functionality": "Balanced PSU",
        "family": "Hazay–Nissim Protocol 8 π∪ (DDH, ElGamal, Pedersen, ZK; semi-honest/debug path)",
        ...
        "factory": "PsuFactory",
        "driver": "PsuMain",
        "bench_dir": "psu/24_HN12",
        "ot_status": "NO_OT",
        "init": "DDH group + ElGamal/Pedersen key setup (client).",
        "online": "Protocol 5 stack through evals; recover Y \\ X when both poly evaluations are nonzero; send union to P2.",
        "notes": (
            "Bench configs use hn12_semi_honest_debug / ideal PRF by default. Legacy Protocol 5 PSI "
            "(Hn12Psi*) remains for unit tests; fair bench uses PSU."
        ),
    },
    {
        "name": "CCS:TCLZ23",
