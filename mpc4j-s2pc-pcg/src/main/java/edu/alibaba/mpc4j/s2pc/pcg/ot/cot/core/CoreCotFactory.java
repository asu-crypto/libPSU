...
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.core.roy22.Roy22SoftSpokenCoreCotReceiver;
import edu.alibaba.mpc4j.s2pc.pcg.ot.cot.core.roy22.Roy22SoftSpokenCoreCotSender;
...
public class CoreCotFactory implements PtoFactory {
    ...
    public enum CoreCotType {
        ...
        KOS15,
        /**
         * Roy22 SoftSpoken OT (EUROCRYPT 2022), libOTe's reference base OT for PT26 / TBZ25 / CSS25.
         * <strong>Component 1 of 2 implemented:</strong> subspace VOLE, semi-honest, k=2. Produces
         * correct COT correlations and halves Pto wire bandwidth vs IKNP03. The remaining Component
         * 2 (GGM-puncture init + linear subspace-code amortization) is documented in
         * {@code mpc4j-s2pc-pcg/src/main/java/edu/alibaba/mpc4j/s2pc/pcg/ot/cot/core/roy22/README.md}.
         */
        ROY22_SOFT_SPOKEN,
    }
    ...
    public static CoreCotSender createSender(Rpc senderRpc, Party receiverParty, CoreCotConfig config) {
        ...
        switch (type) {
            ...
            case ROY22_SOFT_SPOKEN:
                return new Roy22SoftSpokenCoreCotSender(senderRpc, receiverParty, (Roy22SoftSpokenCoreCotConfig) config);
            default:
    ...
    public static CoreCotReceiver createReceiver(Rpc receiverRpc, Party senderParty, CoreCotConfig config) {
        ...
        switch (type) {
            ...
            case ROY22_SOFT_SPOKEN:
                return new Roy22SoftSpokenCoreCotReceiver(receiverRpc, senderParty, (Roy22SoftSpokenCoreCotConfig) config);
            default:
                throw new IllegalArgumentException("Invalid " + CoreCotType.class.getSimpleName() + ": " + type.name());
        }
    }
