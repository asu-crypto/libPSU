...
public class CuckooHashBinFactory {
    ...
    public enum CuckooHashBinType {
        ...
        /**
         * No-stash PSZ18 cuckoo hashing with 3 hash functions and the paper-CSSW25 packing
         * ε&nbsp;=&nbsp;0.4 (i.e. β&nbsp;=&nbsp;⌈1.4·n⌉). This matches §6 of Chandran et al.
         * (ASIACCS&nbsp;2025), §5.4 of which fixes ε&nbsp;=&nbsp;0.4 for the inner Circuit-PSI
         * Cuckoo table. Behaviourally identical to {@link #NO_STASH_PSZ18_3_HASH} but with a
         * larger table, giving a stronger empty-stash guarantee at the cost of more bins.
         * <p>
         * Only CSS25's Circuit-PSI Cuckoo path uses this type today. Other protocols that select
         * {@code NO_STASH_PSZ18_3_HASH} keep ε&nbsp;=&nbsp;0.27 (β&nbsp;=&nbsp;⌈1.27·n⌉).
         * </p>
         */
        NO_STASH_PSZ18_3_HASH_E04,
    }
    ...
    public static <T> CuckooHashBin<T> createCuckooHashBin(EnvType envType, CuckooHashBinType type,
        ...
        return switch (type) {
            ...
            case NO_STASH_PSZ18_3_HASH, NO_STASH_PSZ18_4_HASH, NO_STASH_PSZ18_5_HASH, NO_STASH_PSZ18_3_HASH_E04 ->
    ...
    public static boolean isNoStashType(CuckooHashBinType type) {
        return switch (type) {
            case NO_STASH_ONE_HASH, NO_STASH_NAIVE, NO_STASH_PSZ18_3_HASH, NO_STASH_PSZ18_4_HASH,
                 NO_STASH_PSZ18_5_HASH, NO_STASH_PSZ18_3_HASH_E04 -> true;
    ...
    private static void checkInputs(CuckooHashBinType type, int maxItemSize, int binNum, byte[][] keys) {
        ...
        switch (type) {
            ...
            case NO_STASH_PSZ18_3_HASH_E04:
    ...
    public static int getHashNum(CuckooHashBinType type) {
        return switch (type) {
            ...
            case NAIVE_2_HASH -> 2;
            case NAIVE_3_HASH, NO_STASH_NAIVE, NO_STASH_PSZ18_3_HASH, NO_STASH_PSZ18_3_HASH_E04 -> 3;
    ...
    public static int getStashSize(CuckooHashBinType type, int maxItemSize) {
        return switch (type) {
            ...
            case NO_STASH_NAIVE, NO_STASH_PSZ18_3_HASH, NO_STASH_PSZ18_4_HASH, NO_STASH_PSZ18_5_HASH,
                 NO_STASH_PSZ18_3_HASH_E04 -> 0;
            default ->
                throw new IllegalArgumentException("Invalid " + CuckooHashBinType.class.getSimpleName() + ": " + type.name());
        };
    }
